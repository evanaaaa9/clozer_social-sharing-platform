    ...
    return (
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', background: '#f4f3f0', fontFamily: "'DM Sans', sans-serif" }}>
            <div style={{ background: '#fafafa', border: '1px solid #e8e6e1', borderRadius: '20px', padding: '3rem', width: '100%', maxWidth: '420px' }}>
                ...
                <h2 style={{ fontFamily: "'DM Serif Display', serif", fontSize: '2rem', marginBottom: '0.4rem' }}>Welcome back</h2>
                <p style={{ color: '#5c5a55', fontSize: '0.9rem', marginBottom: '2rem', fontWeight: 300 }}>Log in to your circles</p>
                ...
                <p style={{ textAlign: 'center', fontSize: '0.88rem', color: '#5c5a55' }}>
                    Don't have an account? <Link to="/register" style={{ color: '#2a7c5a', textDecoration: 'none', fontWeight: 500 }}>Sign up</Link>
                </p>
            </div>
        </div>
    )
